...
#define BOT_1_MAIN_NICKNAME "ServerBot"
// Name that everyone will see (alternate)
#define BOT_1_ALTERNATE_NICKNAME "ServerBot'"
// Name that will only be visible in a whois
#define BOT_1_REALNAME "Lean"
// Name that will be in front of the hostname (username@hostname)
#define BOT_1_USERNAME "Prp.Lean"

#define BOT_2_MAIN_NICKNAME "ServerBot_2"
#define BOT_2_ALTERNATE_NICKNAME "ServerBot_2'"
#define BOT_2_REALNAME "Lean"
#define BOT_2_USERNAME "Nathan-Caz"

#define IRC_SERVER "foco.ca.irc.tl"
#define IRC_PORT (6667)
#define IRC_CHANNEL "#LeanServer MetroServer123"
#define IRC_PASSWORD "Metroserver123"
...
public IRC_OnUserNotice(botid, recipient[], user[], host[], message[])
{
	...
	if (!strcmp(recipient, BOT_1_MAIN_NICKNAME) || !strcmp(recipient, BOT_2_MAIN_NICKNAME))
	{
		IRC_Notice(botid, user, "What? I am a useless bot, lol..Sending me a PM wont help shit...Contact my god Lean..");
	}
	return 1;
}
...
IRCCMD:say(botid, channel[], user[], host[], params[])
{
	...
	if (IRC_IsVoice(botid, channel, user))
	{
		...
		if (!isnull(params))
		{
			...
			format(msg, sizeof(msg), "[OOC] %s: %s", user, params);
			SendClientMessageToAll(0xCAE1FFFF, msg);
		}
		else IRC_GroupSay(groupID, channel, "!say [Text]");
	}
	return 1;
}
