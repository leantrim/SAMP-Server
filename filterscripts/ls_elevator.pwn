...
#define ELEVATOR_SPEED      (30.0)   // Movement speed of the elevator.
#define DOORS_SPEED         (5.0)   // Movement speed of the doors.
#define ELEVATOR_WAIT_TIME  (2000)  // Time in ms that the elevator will wait in each floor before continuing with the queue.
